...
public class InsertionSortTest {
	...
	public void sort0() throws Exception {
		...
		System.out.println("Expected:" + String.valueOf(list.size() - 1));
		System.out.println("Actual:" + String.valueOf(compares));
	...
	public void sort2() throws Exception {
		...
		// If we use true random seed and this test fails, just increase the delta a
		// little.
